...
// constructor
    ...
    <p><label for="<?php echo $this->get_field_id('see_all_text'); ?>"><?php _e('Add the text for the button here if you want to change the default <em>Approfondisci</em>', 'moesia'); ?></label>
	...
	function widget($args, $instance) {
		...
		$category = isset( $instance['category'] ) ? esc_attr($instance['category']) : '';
		$see_all_text = isset( $instance['see_all_text'] ) ? esc_html($instance['see_all_text']) : __( 'Approfondisci', 'moesia' );		
...
?>
		<section id="latest-news" class="latest-news-area">
			<div class="container">
                ...
                -->
                <a href="/prodotti" class="all-news"><?php echo $see_all_text; ?></a>
