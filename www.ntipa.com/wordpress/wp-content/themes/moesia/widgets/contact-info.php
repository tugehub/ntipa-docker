...
// constructor
	...
	function widget($args, $instance) {
		...
		if( ($address) ) {
			...
			echo '<span><i class="fa fa-home"></i>' . __('Indirizzo: ', 'moesia') . '</span>' . $address;
			echo '</div>';
		}
		if( ($phone) ) {
			echo '<div class="contact-phone">';
			echo '<span><i class="fa fa-phone"></i>' . __('Telefono: ', 'moesia') . '</span>' . $phone;
			echo '</div>';
		}
		if( ($email) ) {
			echo '<div class="contact-email">';
			echo '<span><i class="fa fa-envelope"></i>' . __('E-mail: ', 'moesia') . '</span>' . '<a href="mailto:' . $email . '">' . $email . '</a>';
			echo '</div>';
		}				
